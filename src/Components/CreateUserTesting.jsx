...
const CreateUserTesting = ({ history, match }) => {
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      helperText={
                        errors &&
                        errors.map(
                          (err) => err.context.key === "fullname" && err.message
                        )
                      }
                    />
                  </Grid>
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      helperText={
                        errors &&
                        errors.map(
                          (err) => err.context.key === "username" && err.message
                        )
                      }
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} sm={6}>
                    <TextField
                      ...
                      helperText={
                        errors &&
                        errors.map(
                          (err) => err.context.key === "password" && err.message
                        )
                      }
                    />
                  </Grid>
